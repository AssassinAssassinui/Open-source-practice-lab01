# Open source practice [![](https://github.com/guisabellla/Open-source-practice-lab01/workflows/tests/badge.svg)](https://github.com/guisabellla/Open-source-practice-lab01/actions?query=workflow%3Atests)
